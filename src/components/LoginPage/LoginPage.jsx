...
const LoginPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (validateForm()) {
      ...
      axios.post(`${BASE_URL}/GoMart/users/loggedin`,userData)
        .then((response) => {
      ...
      toast.error("Form is invalid. Please check the fields and try again.", { autoClose: 2000 });
  ...
  return (
    <div className="login-container">
      ...
      <div className="login-box">
        ...
        <footer>
          Powered by <span className="hed1">Combat</span><span className="hed2">Team</span>
        </footer>
      </div>
    </div>
  );
